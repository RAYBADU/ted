...
const SpeakerCards = ({ id, image, name, role, bio }) => {
  return (
    <motion.div
    ...
    >
      <Link to={`/speakers/${id}`}>
        <div className="relative group overflow-hidden cursor-pointer">
          ...
          {/* red circle */}
          <div
            className="size-96 absolute  rounded-full border-2 border-red-600
                        top-1/8 left-1/2 -translate-x-1/2 -translate-y-1/2F
                        opacity-0 scale-75
